...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getSession().get("domain.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria("domain.User")
	...
	public List findByUserIcon(Object userIcon) {
		return findByProperty(USER_ICON, userIcon);
	}
